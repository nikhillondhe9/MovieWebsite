...
zoo = media.Movie(
                 ...
                 movie_storyline="In a city of anthropomorphic animals, a rookie"  # NOQA
                                   "bunny cop and a cynical con artist fox must work"  # NOQA
...
incredibles = media.Movie(
                 ...
                 movie_storyline="A family of undercover superheroes,"
"                                   while trying to live the quiet suburban life,"  # NOQA
...
tdk = media.Movie(
                 ...
                 movie_storyline="When the menace known as the Joker emerges from his mysterious past,"  # NOQA
                                   " he wreaks havoc and chaos on the people of Gotham, the Dark Knight"  # NOQA
                                   " must accept one of the greatest psychological and physical tests of"  # NOQA
...
walter = media.Movie(
                 ...
                 movie_storyline="When his job along with that of his co-worker"  # NOQA
                                   " are threatened, Walter takes action in the"  # NOQA
                                   " real world embarking on a global journey that"  # NOQA
...
drishyam = media.Movie(
                 ...
                 movie_storyline="Desperate measures are taken by a man who tries"  # NOQA
                                   " to save his family from the dark side of the law,"  # NOQA
...
tid = media.Movie(movie_title="3 Idiots",
                 ...
                 movie_storyline="Two friends are searching for their long lost companion."  # NOQA
                                   " They revisit their college days and recall the memories"  # NOQA
...
dangal = media.Movie(
                 ...
                 movie_storyline="Former wrestler Mahavir Singh Phogat and his"  # NOQA
                                   " two wrestler daughters struggle towards glory"  # NOQA
                                   " at the Commonwealth Games in the face of societal oppression.",  # NOQA
                 poster_image="https://images-na.ssl-images-amazon.com/images/M/MV5BMTQ4MzQzMzM2Nl5BMl5BanBnXkFtZTgwMTQ1NzU3MDI@._V1_SY1000_CR0,0,713,1000_AL_.jpg"  # NOQA
                 )
